...
export default function HelloStylesScreen({ navigation }) {
  ...
  return (
    <ScrollView style={styles.scrollContainer}>
      <View style={styles.container}>
        <Text style={styles.header}>Style Guide Demo</Text>
        ...
        >
          <Text style={styles.backButtonText}>Back to Hello World</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
